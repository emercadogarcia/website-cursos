...
@section('content')
    <div class="grid grid-cols-3 gap-4 mb-2">
            ...
            <ul class="flex flex-col">
                ...
                @foreach ($course->posts as $post)
                    <li class="flex items-center text-gray-600 mt-2">
                        ...
                        @if($post->free)
                            <span
                                class="text-xs text-gray-300 font-semibold bg-gray-200 rounded-full ml-auto">
                                Gratis</span>
                        @endif
                    </li>
                @endforeach
        ...
        <div class="text-gray-700 col-span-2 mb-4">
            ...
            <div class="grid grid-cols-2 gap-4 my-8">
                ...
                {{-- toda la siguientes lineas reemplazada por una sola
    ...
    <div class="text-center mb-4">
        ...
        <h2 class="text-xl text-gray-600">Fórmate online como profesional en Tecnologías</h2>
    </div>
